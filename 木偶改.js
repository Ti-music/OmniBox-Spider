...
const DRIVE_ORDER = splitConfigList(process.env.DRIVE_ORDER || "baidu;tianyi;quark;uc;xunlei;115;ali;123pan").map(s => s.toLowerCase());
// 详情链路缓存时间（秒），默认 12 小时
...
if (typeName.includes ('115')) return
